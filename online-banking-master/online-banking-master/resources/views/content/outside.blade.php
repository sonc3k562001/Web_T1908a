...
@section('main')
    <section class = "transaction-outside col-xs-12 col-md-12">
        <div class = "container">
            <div class = "row">
                <h2>Transaction to different bank</h2>

                <div class = "transaction-outside-section col-xs-6 col-md-6">
                    <form action="{{url('/success')}}">
                        ...
                        <textarea type="text" id="message" name="message" rows="5" cols="50" maxlength="140" required></textarea><br>
