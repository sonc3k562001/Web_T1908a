...
<body>
<header>
    <a href="{{route('userb.index')}}" class="header-brand">SONDZ</a>
    <nav>
        <ul>
            <li><a href="{{route('userb.index')}}">Click here</a></li>
        </ul>
    </nav>
</header>
...
<footer>
    <div class="container">
        <ul class="footer-links-main">
            <li><a href="{{route('userb.index')}}">Home</a></li>
            <li><a href="{{route('userb.index')}}">Product</a></li>
        </ul>
